...
run_RCTD_project <- function(projDir, col){
  ...
  # }
  # reference.I <- createRef(refI_count_fn, refI_meta_fn, 'bio_celltype')
  # st = Sys.time()
  # props.I <- run_RCTD(mixture.spatial,reference.I, max_cores = 20, CELL_MIN_INSTANCE = 5)
  # et = Sys.time()
  # print(et-st)
  # write.csv(props.I, file.path(projDir, 'RCTD_estimated_proportions_external_immune_only.csv'))
...
system.time(run_RCTD_project(projDir, 'bio_celltype'))
